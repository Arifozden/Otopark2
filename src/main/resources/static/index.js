...
function bilgiDuzenle(arabalar){
    let yaz="<table><tr><th>TC</th><th>Ad</th><th>Adres</th>"+
        "<th>Plaka</th><th>Marka</th><th>Model</th></tr>";
    for(const araba of arabalar){
        yaz+="<tr><td>"+araba.tc+"</td><td>"+araba.ad+"</td><td>"+araba.adres+
            +"</td><td>"+araba.plaka+"</td><td>"+araba.marka+"</td><td>"+araba.model+"</td></tr>";
    }
    yaz+="</table>";
    $("#arabalar").html(yaz);
}
